...
#     pipeline=generator,
#     callbacks=[LLMCallbackHandler(Path("prompts.jsonl"))]  # your existing logger
# )
...
# Agent 1 : Database Developer Agent will construct SQL queries
sql_dev = Agent(
    ...
    backstory=dedent(
        ...
        Use the `check_sql` to verify queries against the database tables.
    """
    ),
    llm=llm,
...
# Kickoff the Crew
inputs = {
    "query": "What are different categories of employment type?"
}
